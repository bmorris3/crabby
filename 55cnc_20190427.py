...
# Image paths
image_paths = sorted(glob('/Users/bmmorris/data/saintex/2019_55cnc/20190427/Raw/*.fts'))[10:]
dark_paths = glob('/Users/bmmorris/data/saintex/2019_55cnc/20190427/Dark/*.fts')
flat_paths = glob('/Users/bmmorris/data/saintex/2019_55cnc/20190427/Flat/*.fts')
master_flat_path = 'outputs/masterflat_20190427.fits'
master_dark_path = 'outputs/masterdark_20190427.fits'
...
star_positions = np.array([[1096, 1093], [1378, 1719]])

output_path = 'outputs/55cnc_20190427.npz'
