...
# Image paths
image_paths = sorted(glob('/Users/bmmorris/data/saintex/2019_55cnc/20190410/Raw/*.fts'))
dark_paths = glob('/Users/bmmorris/data/saintex/2019_55cnc/20190410/Dark/*.fts')
flat_paths = glob('/Users/bmmorris/data/saintex/2019_55cnc/20190410/Flat/*.fts')
master_flat_path = 'outputs/masterflat_20190410.fits'
master_dark_path = 'outputs/masterdark_20190410.fits'
...
star_positions = np.array([[1100, 1090], [1340, 1819]])

output_path = 'outputs/55cnc_20190410.npz'
