...
# Image paths
image_paths = sorted(glob('/Users/bmmorris/data/saintex/2019_55cnc/20190327/Raw/*.fts'))
dark_paths = glob('/Users/bmmorris/data/saintex/2019_55cnc/20190327/Dark/*.fts')
flat_paths = glob('/Users/bmmorris/data/saintex/2019_55cnc/20190330/Flat/*.fts')
master_flat_path = 'outputs/masterflat_20190327.fits'
master_dark_path = 'outputs/masterdark_20190327.fits'
...
star_positions = np.array([[1141, 1188], [1377, 1920]])

output_path = 'outputs/55cnc_20190327.npz'
...
X = np.vstack([light_curve,
               ...
               minus_airmass**2,
               dx, dy,
               phot_results.background_median[start:stop]]).T
# print(transit_model_e(phot_results.times[:-2]))
